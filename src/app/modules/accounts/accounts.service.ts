...
export class AccountsService {
    ...
    getAccounts(query?: string, filters?: any, sort?: any, page?: number, pageSize?: number): Observable<AccountsListData> {
        ...
        return this.api.post<ApiResponse<AccountsListData>, SearchApiPayload>('accounts/search', body).pipe(
            catchError(error => {
    ...
    createAccount(payload: createAccountRequest): Observable<Account> {
        return this.api.post<ApiResponse<Account>, createAccountRequest>('accounts/create', payload).pipe(
            catchError(error => {
                this.errorHandler.handleError(error);
    ...
    updateAccount(id: string, payload: createAccountRequest): Observable<Account> {
        return this.api.post<ApiResponse<Account>, createAccountRequest>(`accounts/${id}/update`, payload).pipe(
            catchError(error => {
                this.errorHandler.handleError(error);
                return of({} as Account);
            }),
    ...
    getActivityLogs(accountId: string): Observable<AccountActivityLog[]> {
        return this.api.get<ApiResponse<AccountActivityLog[]>>(`accounts-activities/account/${accountId}`).pipe(
            catchError(error => {
                this.errorHandler.handleError(error);
